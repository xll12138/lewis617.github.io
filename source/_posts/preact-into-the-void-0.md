...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj6n75o3dfj21fm0yyk30.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7cmp9hotj21aa0ms75t.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7hwm3j0aj21e80vmq6t.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7i7h7npgj21e60ym7aw.jpg)

JSX的精髓就是我们看过的那个工厂函数，它非常简单，只有一个接受节点名称、属性、children的签名。节点名称就是之前说的标签名称，它可以是字符串或者函数，属性是可选的，它可以是个对象，剩余的参数就是children，这就是我们编写的形式。
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7imbjvoaj21es0wyaf8.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7iwejmd8j21h80zctcs.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7j3w1fauj216a0uowil.jpg)

## 虚拟DOM

下个话题是虚拟DOM。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7jgwtbo2j21ku0pm40e.jpg)

虚拟DOM仅仅只是个代表树状结构的对象而已，仅仅如此，没啥别的玄乎的！我经常把它想成一个传递给DOM构建器的一个配置，好让DOM构建器不那么理论化。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7jgd8tvwj21cg0tijuo.jpg)

不过，首先我们要理解的是，我们如何从JSX到虚拟DOM。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7jqrweslj21dg0xin25.jpg)

我们所做的方式是调用刚才定义参数的那个h函数。这非常容易理解，我们编写JSX，然后调用h函数，我们要做的就是定义一个h函数，生成这样的对象。这个对象就是虚拟DOM，虚拟DOM就是一个嵌套对象。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7ju59ctmj21j40ymdkp.jpg)

令人惊讶的简单，我们要做的就是这个而已！一个只有一行代码的函数！当然，你可以在这里做更多的事情，如果你想扁平化children，去除空值，连接相邻的字符串节点等。但核心是，你可以通过这个函数编写一个虚拟DOM渲染器。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7jzhp1zkj21au0xkado.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7k5n7wtaj21fw10gtir.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7kwyjmokj21d60vaagy.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7l08enxfj21bk0w6449.jpg)

这时你可能想问，这能运行吗？这是个虚拟DOM，我们把它传给编写的渲染函数。右边显示的是结果，它可以运行哈哈。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7lfhftmqj21e00vgdjz.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7mzdwm1fj21eo0wq0yj.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7myx049ij21eu104n3t.jpg)
...
> 译者注：这里需要对数据结构有一定基础才能理解，比如列表为何只能push和pop，而map却可以改变中间的项。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7obuoj1jj21fc0wsgtk.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7occh61uj21gk0v8q7p.jpg)

## 性能

我想和大家讨论一些性能的话题。我编写Preact时，就想测试它的性能。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7qby6v8wj21hu0mggob.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7r2tleloj218y0ic40u.jpg)

接下来，我想分享我在编写DOM库过程中的一些经验，第一个是使用文本节点来表示文本。这听起来很傻，我意识到了这个。但是很惊讶的是，我们经常曲解这句话。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7r3v1w7kj21ao0s8jtn.jpg)

DOM拥有API去和文本打交道，我们却经常忽略这些API。我们可以通过这些API去创建文本，插入文本，反转文本等。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7r8yo1wqj21gu0ty0xg.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7rhq0ed9j217w0w2gq2.jpg)

下一个经验是，避免getters，完全的！别使用它们。Text的nodeType是undefined，但是它继承的Node的nodeType是个getter方法，性能不好。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7rrtjekbj21gy0jy7ac.jpg)

如图所示，splitText更快，因为这只是检查某个属性是否存在，而不是调用getter。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7rthnnovj21fk0vygpx.jpg)

这是一个性能测试，可以看到getters都很慢，而属性获取的速度却很快。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7rw7qmooj21jg0yatha.jpg)

最后一个经验是避免Live NodeLists，不要试图去用它们，它们特别耗性能。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7s0yww8aj21a20uk0uz.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7s1eagrrj21ea0w20xj.jpg)

这是测试结果。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7s85x3i6j21i60wy0x7.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7sacjfgpj21ii0pm76d.jpg)

Chrome开发工具优化了这个，使其更加可视化。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7shbtvtuj21gk0y8k0g.jpg)

另一个工具是IRHydra。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7shuxscpj21ds0wih0c.jpg)

最后一个工具是ESBench。这个工具的目的是给你一个非常简单的用户界面去使用Babel和benchmark。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7sj2xdv0j21b00wutdi.jpg)
...
![](http://ww1.sinaimg.cn/large/83900b4egy1fj7srvrm9xj21ag0v4tbo.jpg)

下一个经验是行内帮助函数。函数可以更加通用。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7swa4vo9j21au0vujvc.jpg)

下一个是短路语法。最便宜的函数调用就是你不调用它。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7syosb7aj21cg0ue41l.jpg)

所有这一切都是在说一个道理：基于数据去做决定。

![](http://ww1.sinaimg.cn/large/83900b4egy1fj7sz6p7llj21cw0moqv5.jpg)
