...
本书适合有一定的 ES6/7、Node 开发经验，想要使用 React 与 Redux 开发应用的前/后端程序员阅读参考。零基础的同学请先补习 ES6/7 和 Node 的基础知识，否则这本书会让你怀疑人生。
...
- **别照搬：**本书示例程序中的开发经验来自开源社区和我自己的实践思考。我不认为这是使用 React 与 Redux 开发 Web 应用程序的唯一方式。你应该将本书作为一种参考，然后总结出属于自己的一套实践方案。
