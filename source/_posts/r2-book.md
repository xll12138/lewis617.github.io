...
- **跑例子：**本书名为《React 与 Redux 开发实例精解》，因此请务必将示例代码克隆到本地，一边运行例子，一边阅读本书，切勿将本书当作《三国演义》来读。
- **看文档：**为了不让读者白花钱，本书故意避开了对各种在线文档的赘述，因此在阅读本书时，你还需要根据书中的提示去阅读相应的在线文档。
- **提问题：**React 与 Redux 诞生于“JavaScript 疲劳期”，本身就非常复杂，如果在阅读过程中遇到解决不了的问题，请不要感到沮丧，可以到 GitHub 提交Issue，或给我发邮件（lewis617@163.com），我会第一时间解答你的问题。
